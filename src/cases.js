...
export const cardFacts = {
  "career-os": {
    tab: "Career OS",
    marks: ["SOLO BUILD", "18 DAYS", "Ship the whole journey", "DEPLOYED"],
  ...
  midas: {
    tab: "M.I.D.A.S",
    marks: ["PRIVATE SYSTEM", "DECISION COUNCIL", "Argue the other side", "READ-ONLY"],
  ...
  vtac: {
    tab: "VTAC",
    marks: ["MELBOURNE", "STUDENT PATHWAYS", "One clear next step", "TEAM PROJECT"],
  ...
  research: {
    tab: "RMIT CIAIRI",
    marks: ["MELBOURNE", "RESEARCH NOTES", "Ask what it supports", "RMIT CIAIRI"],
    caption: "ASK A BETTER QUESTION",
    ink: "#982f37",
    paper: "#eee9e7",
  ...
  metaxy: {
    tab: "Metaxy",
    marks: ["EXPLORATORY", "BEHAVIOURAL NOTES", "Keep the alternative", "SOLO BUILD"],
  ...
  insight: {
    tab: "Insight Engine",
    marks: ["IN PROGRESS", "SAVED IDEAS", "Bring it back when useful", "SOLO BUILD"],
    caption: "KEEP THE GOOD IDEAS",
    ink: "#654399",
    paper: "#eee9f4",
    role: "Solo build",
    scale: "In progress",
  ...
  "second-brain": {
    tab: "Second Brain",
    marks: ["ONGOING", "PLAIN MARKDOWN", "The format outlasts the tool", "SOLO BUILD"],
    caption: "LEARNING, CONNECTED",
    ink: "#64462f",
    paper: "#f3eadb",
    role: "Solo build",
    scale: "Ongoing",
